...
##########################################################################################
# path traversal  (adopted From https://github.com/gehaxelt/phuzz/tree/main/code/web/instrumentation/overrides.d)                                  #
##########################################################################################
...
uopz_set_return(
    ...
    function ($filename, $group) {
        ...
        if ($result === false) {
            ...
            file_put_contents(__LOG_FUNCTION_PATH  . ".json", $json . "\n", FILE_APPEND);
            chmod(__LOG_FUNCTION_PATH  . ".json", 0777);
